...
const Footer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email || !isChecked) {
      setFormErrors("Bitte füllen Sie alle Felder aus!"); // Please fill in all fields!
      return;
    }
    ...
    try {
      ...
      console.error('Netzwerkfehler:', error); // Network error:
  ...
  return (
    <footer className="bg-color-primary border-t-2 border-color-accent">
      <div className="container flex flex-col gap-10 pt-10 pb-4">
        ...
        <div className="flex justify-between gap-12">
          <div className="flex flex-row gap-12">
            <div className="flex flex-col gap-2">
              <h4>Adresse</h4>
              <address className="not-italic text-color-gray">
            ...
            <div className="flex flex-col gap-2">
              ...
              <nav className="flex flex-col gap-1">
                ...
                <Link href="/about" className="whitespace-nowrap">Über uns</Link>
                <Link href="/pickup" className="whitespace-nowrap">Fahrzeug abholen</Link>
                <Link href="/contact">Kontakt</Link>
                <Link href="/account" className="whitespace-nowrap">Mein Konto</Link>
          ...
          <div className="flex flex-col gap-4 min-w-[240px] max-w-[400px] w-full">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex gap-10 items-center">
                ...
                <div className="flex gap-6">
                  ...
                  <Link href="https://web.telegram.org/" aria-label="Telegram" target="blank">
                  ...
                  <Link href="https://www.viber.com/" aria-label="Viber" target="blank">
        ...
        <p className="text-sm text-color-gray text-center">
